...
public class Barangay_Certificate extends AppCompatActivity {
    Uri selected_cedula;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barangay_certificate);
        ...
        //DB SQL
        databasehelper = new DatabaseHelper(Barangay_Certificate.this);
                        ...
                        if(selected_cedula != null){
                            if(purpose_4.isChecked()){
                                if (TextUtils.isEmpty(showOther.getText().toString().trim())) {
                                    ...
                                    doc_name.setText("Barangay Certificate");
                                    ...
                                    send_request_overview.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            if(value.getBoolean("barangay_certificate").equals(false)){
                                                ProgressDialog progressDialog_cedula = new ProgressDialog(Barangay_Certificate.this);
                                                ...
                                                Address_storageRef.putFile(selected_cedula).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                                        ...
                                                        user_request.put("type", "barangay_certificate");
                                                        ...
                                                        RequestListRef.document().set(user_request).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            ...
                                                            public void onSuccess(Void unused) {
                                                                ...
                                                                okay_btn_success.setOnClickListener(new View.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(View view) {
                                                                        Intent BackToServices = new Intent(Barangay_Certificate.this, Services.class);
                                                                        BackToServices.putExtra("transaction_update",true);
                                                                        BackToServices.putExtra("type","barangay_certificate");
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(Barangay_Certificate.this, "Transaction Failed: ERROR["+e.toString()+"]", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Barangay_Certificate.this, "Please pick a purpose", Toast.LENGTH_SHORT).show();
                            }

                        }else{
                            file_upload_id.setBackgroundColor(Color.RED);
                            Toast.makeText(Barangay_Certificate.this, "Please attach a file", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
