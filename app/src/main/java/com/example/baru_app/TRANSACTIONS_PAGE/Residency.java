...
public class Residency extends AppCompatActivity {
    Uri selected_cedula;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DB SQL
        databasehelper = new DatabaseHelper(Residency.this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                switch (position){
                    case 0:
                        final_price.setText("₱ 20.00");
                        break;
                    case 1:
                        final_price.setText("₱ 40.00");
                        break;
                    case 2:
                        final_price.setText("₱ 60.00");
                        break;
                    case 3:
                        final_price.setText("₱ 80.00");
                        break;
                    case 4:
                            ...
                            if(purpose_4.isChecked()){
                                if (TextUtils.isEmpty(showOther.getText().toString().trim())) {
                                    ...
                                    send_request_overview.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            if(value.getBoolean("certificate_residency").equals(false)){
                                                ProgressDialog progressDialog_cedula = new ProgressDialog(Residency.this);
                                                ...
                                                Address_storageRef.putFile(selected_cedula).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                                        ...
                                                        user_request.put("type", "certificate_residency");
                                                        ...
                                                        RequestListRef.document().set(user_request).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            ...
                                                            public void onSuccess(Void unused) {
                                                                ...
                                                                okay_btn_success.setOnClickListener(new View.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(View view) {
                                                                        Intent BackToServices = new Intent(Residency.this,Services.class);
                                                                        BackToServices.putExtra("transaction_update",true);
                                                                        BackToServices.putExtra("type","certificate_residency");
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(Residency.this, "Transaction Failed: ERROR["+e.toString()+"]", Toast.LENGTH_SHORT).show();
                                ...
                                transaction_overview.show();
                                doc_copy.setText(spinner.getSelectedItem().toString());
                                doc_name.setText("Certificate of Residency");
                                ...
                                Toast.makeText(Residency.this, "Please pick a purpose", Toast.LENGTH_SHORT).show();
                            }

                        }else{
                            file_upload_id.setBackgroundColor(Color.RED);
                            Toast.makeText(Residency.this, "Please attach a file", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
